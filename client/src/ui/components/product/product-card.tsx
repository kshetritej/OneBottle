  ...
  return (
    <Card className="w-full max-w-sm mx-auto overflow-hidden">
      ...
      <CardContent className="p-4">
        <h3 className="text-lg font-semibold mb-1 sm:text-xl">Highland Mist Whiskey</h3>
        ...
        <div className="flex justify-between items-center">
          <div>
            <span className="text-2xl font-bold sm:text-3xl">$59.99</span>
